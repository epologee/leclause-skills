...
name: art-director
user-invocable: true
description: Use at the start of a new product, brand refresh, or design-system foundation, before UI work begins. Triggers on requests for art direction, brand work, visual language, or design system architecture, and on projects that have been building features without a documented brand. Captures who the product is, how it speaks visually, and how its system scales, BEFORE CSS exists. Not for small UI tweaks or per-component review.
effort: high
---
