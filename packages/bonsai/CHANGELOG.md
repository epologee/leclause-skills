...
`/leclause:whats-new bonsai` to re-read at any time.
...
- **`/bonsai prune` no longer auto-removes open-PR worktrees.** Non-integrated worktrees stay unless the operator explicitly confirms removal.
