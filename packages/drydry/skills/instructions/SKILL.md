...
description: >
  ...
  orchestrator in audit mode when CLAUDE.md files (project-level or
  user-level) are within scope, or directly when the operator wants
  only a CLAUDE.md audit. Audits instruction files for two failure
