...
| **dont-do-that** | ❌ | | ✅ | | Eight guardrail hooks that push back on common AI reflexes: shifting blame, stopping prematurely, delegating verification, asking for confirmation when none was needed, and em-dashes in prose. See [dont-do-that](packages/dont-do-that/README.md). |
